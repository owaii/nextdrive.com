  ...
  return (
    <section className="flex-1 flex flex-col gap-3">
      ...
      <div className="w-full flex justify-start">
        <span className="text-l 2xl:text-2xl text-txt-white font-medium sm:text-center">{ title }</span>
      </div>
    </section>
  );
}
    ...
    <section className="relative w-full h-screen bg-transparent flex items-center justify-center">
      ...
      <section className={clsx(
        ...
        <div className="w-full flex justify-start 2xl:justify-center">
          <span className="text-4xl 2xl:text-7xl text-txt-white font-bold">Jazdy doszkalające mają na celu</span>
        </div>

        <section className="w-full flex flex-col gap-8 mt-10 sm:flex-row sm:gap-2 2xl:gap-10 2xl:mt-30">
          <InfoBlock title="naukę obsługi i „wyczucia” pojazdu egzaminacyjnego" image_src="InfoIcon1.png"/>
          <InfoBlock title="sprawdzenie i doskonalenie umiejętności prowadzenia samochodu" image_src="InfoIcon2.png"/>
          <InfoBlock title="przygotowanie do egzaminu w realnych warunkach egzaminacyjnych" image_src="InfoIcon3.png"/>
        </section>
