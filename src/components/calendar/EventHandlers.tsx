...
import { isSameWeek, isDateInRange, isBlockValidForMove } from "./CalendarUtils";
...
export async function handleEventClick( info: EventClickArg, setEvents: Dispatch<SetStateAction<CalendarEvent[]>>, setCurrentUserName: (name: string) => void) {
  info.jsEvent.preventDefault();

  const userId = info.event.extendedProps.userId || null;
