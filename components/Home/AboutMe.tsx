...
export default function AboutMePage() {
  return (
   <section className="w-full h-200 my-20 flex items-center justify-center flex-col">
    <section className="w-full xl:w-1/2 h-140 rounded-4xl bg-(--White) flex shadow-xl py-10 px-5 gap-10 xl:gap-0 flex-col-reverse xl:flex-row">
      <div className="flex-2 xl:flex-3 w-full flex justify-center px-10">
        <span className="text-xs xl:text-xl text-(--Black) font-light space-y-8">
          <p>
      ...
      <section className="flex-1 xl:flex-2 w-full flex items-center justify-center">
